...
from backend.db.utils import db_pool
from backend.utils import config, logger, STATUS_CODES
...
def token_required(f):
    ...
    def decorated(*args, **kwargs):
        ...
        try:
            ...
            queries.check_user_from_token(flask.g.db_con, data["user_id"])
            kwargs["user_id"] = data["user_id"]
            kwargs["login_types"] = data["user_type"]
